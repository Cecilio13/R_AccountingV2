...
class ReportsContent extends React.Component{
    ...
    getReport= async (props) =>{
        ...
        const response = await axios.get('http://localhost/Accounting_modified/public/BudgetSummaryReportdata',{
            params:{
                CostCenterFilter: '',
                                    ...
                                    <div class="col-md-12" style={{backgroundColor : 'white', paddingTop : '15px', paddingBottom : '15px',paddingLeft : '0px', paddingRight : '0px'}}>
                                            ...
                                            <div class="col-md-6" style={{paddingLeft : '0px'}}>
                                                ...
                                                <label class="custom-control-label" for="customCheck13">YTD</label>
                                                    ...
                                                    <select  style={{display : 'none'}} class="form-control" id="filtertemplate" value={this.state.filtertemplate} onChange={(event)=>this.changedates(event.target)}>
                                                        <option>All</option>
                                                        <option>Custom</option>
                                                        <option>This Week</option>
                                                        <option>This Month</option>
                            ...
                            <div class="reportbody">
                                <div id="printablereport_employee_contact_list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" id="report_employee_title" style={{verticalAlign : 'middle', textAlign : "center", fontSize : '14px', fontWeight : 'bold', textTransform : 'uppercase'}} contenteditable="true" >Budget Summary</td>
                                        </tr>
                                        <tr>
