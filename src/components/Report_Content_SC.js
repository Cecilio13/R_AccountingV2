...
class ReportsContent extends React.Component{
    ...
    getReport= async (props) =>{
        ...
        const response = await axios.get('http://localhost/Accounting_modified/public/Supplier_Contact_Listdata',{
            params:{
                CostCenterFilter: '',
                            ...
                            <div class="reportbody">
                                <div id="printablereport_employee_contact_list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" id="report_employee_title" style={{verticalAlign : 'middle', textAlign : "center", fontSize : '14px', fontWeight : 'bold', textTransform : 'uppercase'}} contenteditable="true" >Supplier Contact</td>
                                        </tr>
                                        <tr>
