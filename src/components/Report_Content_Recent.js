...
class ReportsContent extends React.Component{
    ...
    getReport= async (props) =>{
        ...
        const response = await axios.get('http://localhost/Accounting_modified/public/RecentTransactionsdata',{
            params:{
                CostCenterFilter: '',
                ...
                <div id="right-panel" className="right-panel" style={{width : '100%'}}>
                    ...
                    <div className="">
                        ...
                        <div className="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4>Recent Transactions Report</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="reportbody">
                                <div id="printablereport_employee_contact_list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" id="report_employee_title" style={{verticalAlign : 'middle', textAlign : "center", fontSize : '14px', fontWeight : 'bold', textTransform : 'uppercase'}} contenteditable="true" >Recent Transactions</td>
                                        </tr>
                                        <tr>
