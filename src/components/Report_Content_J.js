...
class ReportsContent extends React.Component{
    ...
    getReport= async (props) =>{
        var options =document.getElementById('CostCenterFilter').options;
        var costcenter = [];
        for (var i = 0, l = options.length; i < l; i++) {
            if (options[i].selected) {
                costcenter.push(options[i].value);
            }
        }
        console.log(costcenter);
        const response = await axios.get('http://localhost/Accounting_modified/public/Journal_by_date',{
            params:{
                        ...
                        <div className="container">
                            ...
                            <div class="col-md-12" style={{marginTop : '10px'}}>
                                    <div class="col-md-12" style={{backgroundColor : 'white', paddingTop : '15px', paddingBottom : '15px',paddingLeft : '0px', paddingRight : '0px'}}>
                                            ...
                                            <div class="col-md-6 ">
                                                    <p>Cost Center</p>
                                                    <select class="form-control selectpicker" multiple data-live-search="true" id="CostCenterFilter" onChange={(event)=>this.setState({CostCenterFilter : this.state.CostCenterFilter+1})}>
