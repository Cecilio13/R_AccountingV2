...
class ReportsContent extends React.Component{
                ...
                if(prevState.TO==this.state.TO){
                    if(prevState.CostCenterFilter==this.state.CostCenterFilter){
                        if(prevState.CostCenterFilterJournal==this.state.CostCenterFilterJournal){
                            ...
                            this.getReport(this.props.match.params.no);
                        }
                    }else{
                        this.getReport(this.props.match.params.no);
                    }
    ...
    getReport= async (props) =>{
        var costcenter;
        if(props=="Journal_by_date"){
            costcenter=this.state.CostCenterFilterJournal;
        }else{
            costcenter=this.state.CostCenterFilter;
        }
        const response = await axios.get('http://localhost/Accounting_modified/public/'+props,{
            params:{
    ...
    componentDidMount(){
        if(this.props.match.params.no=="BalanceSheetComparisonByDate"){
            var title="Balance Sheet Comparison";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="BalanceSheetDetailByDate"){
            var title="Balance Sheet Detail";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="BalanceSheetByDate"){
            var title="Balance Sheet";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="ProfitandlossByDate"){
            var title="Profit And Loss";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="sales_transaction_list_by_date"){
            var title="Sales Transaction List";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="expense_transaction_list_by_date"){
            var title="Expense Transaction List";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="AR_REceivable_ageing_by_date"){
            var title="Account Receivable Ageing Summary";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="collectionreport_bydate"){
            var title="Collection";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="Customer_Balance_Summary_by_date"){
            var title="Customer Balance Summary";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="Invoice_List_by_date"){
            var title="Invoice List";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="Open_Invoice_List_by_date"){
            var title="Open Invoice List";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="deposit_detail_by_date"){
            var title="Deposit Detail";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="estimatebycustomer_by_date"){
            var title="Estimate by Customer";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="salesbyCustomer_Summary_by_date"){
            var title="Sales by Customer Summary";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="salesbyProduct_Summary_by_date"){
            var title="Sales by Product Summary";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="ChequeDetail_bydate"){
            var title="Check Detail";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="AccountsPayableByDate"){
            var title="Account Payable";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="AccountsPayableAgeingSummaryByDate"){
            var title="Account Payable Ageing Summary";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="General_Ledger_by_date"){
            var title="General Ledger";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="TransactionListByDateDate"){
            var title="Transaction List";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="MovementinEquityByDate"){
            var title="Movement in Equity";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="Trial_balance_by_date"){
            var title="Trial Balance";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="VAT_List_By_Date"){
            var title="VAT Relief";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        }
        if(this.props.match.params.no=="ledger_for_desc_by_date"){
            var title="Summary of Chart of Accounts Description";
            document.getElementById('HTITLE').innerHTML=title+" Report";
            document.getElementById('report_employee_title').innerHTML=title;
        ...
        this.getReportData();
        this.getReport(this.props.match.params.no);
        console.log("param is "+this.props.match.params.no);
    }
    changedates = (e) =>{
    ...
    exporttoexcelTaxRelief = () =>{
        ...
        var url="https://localhost/Accounting_modified/public/exporttoexcelTaxRelief?CostCenterFilter="+CostCenterFilter+"&filtertemplate="+filtertemplate+"&FROM="+FROM+"&TO="+TO;
                ...
                <div id="right-panel" className="right-panel" style={{width : '100%'}}>
                    ...
                    <div className="">
                        ...
                        <div className="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 id="HTITLE">VAT Relief Report</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div id="printablereport_employee_contact_list">
                                    ...
                                    <tbody>
                                        ...
                                        <td style={{verticalAlign : "middle",textAlign : 'right'}}>
                                            {this.props.match.params.no=="VAT_List_By_Date"? <a href="http://localhost/Accounting_modified/public/export_dat_file" class="btn-link btn-upper-report" title="Export to DAT" ><span class="fa fa-file"></span></a> : ''}
                                            {this.props.match.params.no=="VAT_List_By_Date"? <a href="#" class="btn-link btn-upper-report" title="Export to Excel" onClick={this.exporttoexcelTaxRelief} onclick="exporttoexcelTaxRelief()"><span class="fa fa-table"></span></a> : ''}
                                        ...
                                        <tr>
                                            <td colspan="2" id="report_employee_title" style={{verticalAlign : 'middle', textAlign : "center", fontSize : '14px', fontWeight : 'bold', textTransform : 'uppercase'}} contenteditable="true" >VAT Relief</td>
                                        </tr>
                                        <tr>
